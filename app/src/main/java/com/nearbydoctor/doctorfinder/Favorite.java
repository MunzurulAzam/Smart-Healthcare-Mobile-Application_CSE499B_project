...
import static com.nearbydoctor.utils.AdMobIntegration.loadAdmobBanner;
...
//    private SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LanguageSelectore.setLanguageIfAR( Favorite.this );
    ...
    private class getList extends AsyncTask<String, Integer, Integer> {
        ...
        protected Integer doInBackground(String... params) {
            ...
            FileList.clear();
            sqliteHelper sqliteHelper = new sqliteHelper(Favorite.this);
...
//            db = myDbHelper.getReadableDatabase();
            try {
                Cursor cur = db1.rawQuery("select * from favorite where doctorid=1;", null);
                if (cur.getCount() != 0) {
                    if (cur.moveToFirst()) {
                        do {
                            Getsetfav obj = new Getsetfav();
                            uniqueid = cur.getString(cur.getColumnIndex("uniqueid"));
                            Log.e( "ID", "doInBackground:Asdads "+ uniqueid );
...
//            db = myDbHelper.getReadableDatabase();
            ...
            try {
                ...
                Cursor cur1 = db1.rawQuery("select * from favorite where doctorid=2;", null);
...
//            db = myDbHelper.getReadableDatabase();
            ...
            try {
                ...
                Cursor cur2 = db1.rawQuery("select * from favorite where doctorid=3;", null);
                if (cur2.getCount() != 0) {
                    if (cur2.moveToFirst()) {
                        do {
                            Getsetfav obj = new Getsetfav();
    ...
    public class LazyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            try {
                ...
                switch (doctorid) {
                    case "1":
                        if (CurrentLang.equals( "العربية" )) {
                            ...
                            img_bg.setBackgroundResource(R.drawable.dr_cell1);
                        }else{
                ...
                txt_service.setTypeface(TF_opensansRegular);

                TextView txt_km = vi.findViewById(R.id.txt_distance);
               /* txt_km.setText(data.get(position).getDistance() + " km");*/
                txt_km.setTypeface(tf);
                double Distance = roundMyData(Double.parseDouble(data.get(position).getDistance()), 1);
                txt_km.setText("" + Distance + " " + getString(R.string.distance_miles));
