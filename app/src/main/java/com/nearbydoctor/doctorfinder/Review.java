...
public class Review extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LanguageSelectore.setLanguageIfAR( Review.this );
        setContentView(R.layout.activity_review);

        Intent iv = getIntent();
        profile_id = iv.getStringExtra("profile_id");
        rest = new ArrayList<>();
        relativeLayout=findViewById( R.id.rel_top );
         list_review = findViewById(R.id.list_review);
        new getreviewdetail().execute();

        final Button btn_add_review = findViewById( R.id.add_review);
            ...
            public void onClick(View v) {
                ...
                if (prefs.getString("userid", null) != null) {
                    ...
                    if (uservalue.equals("delete")) {
                        ...
                        /*
                        final RelativeLayout rl_dialoguser = findViewById(R.id.rl_infodialog1);
                         RelativeLayout relativeLayout=findViewById( R.id.rl_infodialog );
            ...
            try {
                ...
                if (image != null) {
                    ...
                    if (click.equals( "signin" )) {
                        Picasso.with(getApplicationContext()).load( getString( R.string.link1 ) + "uploads/" + image ).into( img_user );
                    } else if (click.equals( "fb" )) {
                        Picasso.with(getApplicationContext()).load( "https://"+image ).into( img_user );
                    } else {
                        Picasso.with(getApplicationContext()).load( getString( R.string.link1 ) + "uploads/" + image ).into( img_user );
                    }
                }
