...
import com.nearbydoctor.utils.CommonUtilities;
import com.nearbydoctor.utils.LanguageSelectore;
import com.nearbydoctor.utils.WakeLocker;
import com.nearbydoctor.utils.logingetset;
...
public class Login extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LanguageSelectore.setLanguageIfAR( Login.this );
                ...
                try {
                    ...
                    if (status.equals("Success")) {
                        ...
                        runOnUiThread( new Runnable() {
                            ...
                            public void run() {
                                try {
                                    Toast.makeText( Login.this, job.getString( "Error" ), Toast.LENGTH_SHORT ).show();
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                }
                            }
