...
public class Registernew extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LanguageSelectore.setLanguageIfAR( Registernew.this );
...
//        GCMRegistrar.register(Registernew.this, CommonUtilities.SENDER_ID);
    ...
    private void postdata() {
        ...
        try {
            ...
            e.printStackTrace();
            Log.e( "code", "postdata: "+e.getMessage()  );
        } catch (IOException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public class getlogin extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (status.equals("Success")) {
                ...
                Toast.makeText(Registernew.this, R.string.incorrect_username_password, Toast.LENGTH_LONG).show();
            }
        }
