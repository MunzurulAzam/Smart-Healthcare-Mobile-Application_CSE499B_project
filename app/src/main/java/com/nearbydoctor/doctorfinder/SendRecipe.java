...
import static com.nearbydoctor.doctorfinder.Registernew.verifyStoragePermissions;
...
public class SendRecipe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LanguageSelectore.setLanguageIfAR( SendRecipe.this );
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            ...
            if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK) {
                ...
                Picasso.with(getApplicationContext()).load(shareimage).into(order_img);
