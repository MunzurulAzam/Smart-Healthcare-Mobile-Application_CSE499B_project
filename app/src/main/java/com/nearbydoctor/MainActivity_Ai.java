...
public class MainActivity_Ai extends AppCompatActivity {
...
//    inputMessage.setTypeface(typeface);
    ...
    private void recordMessage() {
        if (listening != true) {
            ...
            listening = true;
            Toast.makeText(MainActivity_Ai.this, "Listening....Click to Stop", Toast.LENGTH_LONG).show();

        } else {
            try {
                microphoneHelper.closeInputStream();
                listening = false;
                Toast.makeText(MainActivity_Ai.this, "Stopped Listening....Click to Start", Toast.LENGTH_LONG).show();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void showError(final Exception e) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(MainActivity_Ai.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        });
    }
